...
namespace SampleBinaryClassification.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\darra\source\repos\mldotnet-real-time-data-streaming-workshop\workspace\FraudPredictionTrainer\data.csv";
